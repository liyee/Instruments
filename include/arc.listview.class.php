...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno",$pagelang='cn')
    {
        ...
        if ($pagelang=='cn'){
            ...
            $maininfo = "<li><span class=\"pageinfo\" style=\"margin: 12px 0;\">Total <strong>{$totalpage}</strong> Page <strong>".$this->TotalResult."</strong> Records</span></li>\r\n";
        }
     ...
     * @return    string
     */
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno",$pagelang='cn')
    {
        global $cfg_rewrite;
        $prepage = $nextpage = '';
        $prepagenum = $this->PageNo-1;
        ...
        if($this->PageNo != 1)
        {
            if($pagelang=='cn') {
                ...
                $indexpage="<li><a href='".$purl."PageNo=1'>Index</a></li>\r\n";
            }            
        }
        else
        {
